...
import tests from './assets/imgs/tests swag labs.jpeg';
...
function Projetos () {
  return (
    ...
    <Row>
      <Col xs lg="4">
        <Card className='card'>
        <Card.Img className='card-imgs' variant="top" src={tests} />
          <Card.Body className='details'>
            <Card.Title className='cardHeader'>
              <Link to="https://github.com/AIROTIVBR/swagLabsTestAuto" target='blank'>Projeto 10</Link>
            </Card.Title>
            <Card.Text className='cardText'>
              Testes automatizados de um site de vendas de produtos, utilizando Java e Selenium.
            </Card.Text>
          </Card.Body>
        </Card>
      </Col>
      ...
      <Card className='card'>
        <Card.Img className='card-imgs' variant="top" src={dash} />
          <Card.Body className='details'>
            <Card.Title className='cardHeader'>
              <Link to="https://github.com/AIROTIVBR/thing-I-ve-been-learning" target='blank'>Projeto 9</Link>
            </Card.Title>
            <Card.Text className='cardText'>
      ...
      <Card className='card'>
        <Card.Img className='card-imgs' variant="top" src={covid} />
          <Card.Body className='details'>
            <Card.Title className='cardHeader'>
              <Link to="https://github.com/AIROTIVBR/Big_Data_Project" target='blank'>Projeto 8</Link>
            </Card.Title>
            <Card.Text className='cardText'>
      ...
      <Card className='card'>
        <Card.Img className='card-imgs' variant="top" src={san} />
          <Card.Body className='details'>
            <Card.Title className='cardHeader'>
              <Link to="https://github.com/AIROTIVBR/Java-Project-OOPJ" target='blank'>Projeto 7</Link>
            </Card.Title>
            <Card.Text className='cardText'>
      ...
      <Card className='card'>
        <Card.Img className='card-imgs' variant="top" src={trunfo} />
          <Card.Body className='details'>
            <Card.Title className='cardHeader'>
              <Link to="https://github.com/AIROTIVBR/Project8?tab=readme-ov-file" target='blank'>Projeto 6</Link>
            </Card.Title>
            <Card.Text className='cardText'>
      ...
      <Card className='card'>
        <Card.Img className='card-imgs' variant="top" src={base} />
          <Card.Body className='details'>
            <Card.Title className='cardHeader'>
              <Link to="https://airotivbr.github.io/Project7/" target='blank'>Projeto 5</Link>
            </Card.Title>
            <Card.Text className='cardText'>
      ...
      <Card className='card'>
        <Card.Img className='card-imgs' variant="top" src={todo} />
          <Card.Body className='details'>
            <Card.Title className='cardHeader'>
            <Link to="https://airotivbr.github.io/Desafio-LTD-Web/" target='blank'>Projeto 4</Link>
            </Card.Title>
            <Card.Text className='cardText'>
      ...
      <Card className='card'>
        <Card.Img className='card-imgs' variant="top" src={guess} />
          <Card.Body className='details'>
            <Card.Title className='cardHeader'>
            <Link to="https://airotivbr.github.io/Project3/" target='blank'>Projeto 3</Link>
            </Card.Title>
            <Card.Text className='cardText'>
      ...
      <Card className='card'>
        <Card.Img className='card-imgs' variant="top" src={sizes} />
          <Card.Body className='details'>
            <Card.Title className='cardHeader'>
            <Link to="https://airotivbr.github.io/Project1/" target='blank'>Projeto 2</Link>
            </Card.Title>
            <Card.Text className='cardText'>
      ...
      <Card className='card'>
        <Card.Img className='card-imgs' variant="top" src={game} />
          <Card.Body className='details'>
            <Card.Title className='cardHeader'>
            <Link to="https://airotivbr.github.io/project--gaming-info/" target='blank'>Projeto 1</Link>
            </Card.Title>
            <Card.Text className='cardText'>
